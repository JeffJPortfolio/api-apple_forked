...
public class UserDao {
	...
	/* 회원 마이페이지폼 */
	public unionVo userSelectOneByNum(int userNum) {
		// System.out.println("UserDao.userSelectOneByNum()");

		unionVo unionVo = sqlSession.selectOne("user.userSelectOneByNum", userNum);
		return unionVo;
	}
	...
	/* 마이페이지폼 구매 */
	public List<unionVo> selectPurchaseProduct(int userNum) {
		System.out.println("userNum" + userNum);

		List<unionVo> purchaseList = sqlSession.selectList("user.selectPurchaseProduct", userNum);
	...
	/* 마이페이지 구매내역 */
	public List<unionVo> selectPurchase(int userNum) {
		System.out.println("userNum" + userNum);

		List<unionVo> purchaseList = sqlSession.selectList("user.selectPurchase", userNum);
		// System.out.println(purchaseList);
